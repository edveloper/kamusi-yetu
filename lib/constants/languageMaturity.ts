...
export const LANGUAGE_MATURITY_DEFINITIONS: Record<LanguageMaturity, LanguageMaturityDefinition> = {
  phrase_ready: {
    ...
    badgeClassName: 'bg-ink-900 text-paper',
  },
  growing: {
    key: 'growing',
    label: 'Growing',
    ...
    badgeClassName: 'bg-petrol-50 text-petrol-600 border border-petrol-200',
  },
  starter: {
    key: 'starter',
    label: 'Starter',
    ...
    badgeClassName: 'bg-sand-50 text-sand-700 border border-sand-200',
  },
  review_heavy: {
    key: 'review_heavy',
    label: 'Review-Heavy',
    ...
    badgeClassName: 'bg-signal-50 text-signal-700 border border-signal-200',
  },
  not_yet_covered: {
    key: 'not_yet_covered',
    ...
    badgeClassName: 'bg-paper-warm text-ink-600 border border-ink-200',
  },
}
