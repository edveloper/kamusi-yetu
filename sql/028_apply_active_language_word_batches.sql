-- 028_apply_active_language_word_batches.sql
-- Purpose:
-- Apply all five validated active-language word-expansion batches in one run,
...
create temporary table _target_word_batches (
  batch_label text primary key
) on commit drop;

insert into _target_word_batches (batch_label)
values
  ('BATCH_KI_WORDS_2026_02_25_A'),
  ('BATCH_LUO_WORDS_2026_02_25_A'),
  ('BATCH_KAM_WORDS_2026_02_25_A'),
...
select
  ...
  s.created_by
from public.entry_import_staging s
join _target_word_batches tb on tb.batch_label = s.batch_label
...
-- where source_ref in (
--   'entry_import_staging:BATCH_KI_WORDS_2026_02_25_A',
--   'entry_import_staging:BATCH_LUO_WORDS_2026_02_25_A',
--   'entry_import_staging:BATCH_KAM_WORDS_2026_02_25_A',
--   'entry_import_staging:BATCH_LUY_WORDS_2026_02_25_A',
--   'entry_import_staging:BATCH_KAL_WORDS_2026_02_25_A'
-- )
