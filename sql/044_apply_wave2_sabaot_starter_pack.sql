-- 044_apply_wave2_sabaot_starter_pack.sql
-- Purpose:
-- Apply the validated Wave 2 Sabaot starter pack.
...
with job as (
  ...
  values (
    ...
    'running',
    false,
    'entry_import_staging:BATCH_SPY_STARTER_2026_02_26_A',
    jsonb_build_object('batch_label', 'BATCH_SPY_STARTER_2026_02_26_A'),
    now()
  )
  returning id
)
...
where s.batch_label = 'BATCH_SPY_STARTER_2026_02_26_A'
...
where job_type = 'translation_import'
  and source_ref = 'entry_import_staging:BATCH_SPY_STARTER_2026_02_26_A'
...
-- from public.bulk_edit_jobs
-- where source_ref = 'entry_import_staging:BATCH_SPY_STARTER_2026_02_26_A'
-- order by created_at desc
-- limit 1;
