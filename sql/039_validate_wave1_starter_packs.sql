-- 039_validate_wave1_starter_packs.sql
-- Purpose:
-- Validate Wave 1 starter packs for newly registered standalone Kenyan languages.
--
-- Covered:
...
with target_batches(batch_label) as (
  values
    ('BATCH_PKO_STARTER_2026_02_26_A'::text),
    ('BATCH_SXB_STARTER_2026_02_26_A'::text),
    ('BATCH_ORC_STARTER_2026_02_26_A'::text)
),
base as (
  select
    s.id,
