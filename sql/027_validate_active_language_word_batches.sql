-- 027_validate_active_language_word_batches.sql
-- Purpose:
-- Validate all five active-language word-expansion batches in one run.
--
-- Batches covered:
...
with target_batches(batch_label) as (
  values
    ('BATCH_KI_WORDS_2026_02_25_A'::text),
    ('BATCH_LUO_WORDS_2026_02_25_A'::text),
    ('BATCH_KAM_WORDS_2026_02_25_A'::text),
    ('BATCH_LUY_WORDS_2026_02_25_A'::text),
    ('BATCH_KAL_WORDS_2026_02_25_A'::text)
),
base as (
  select
    s.id,
