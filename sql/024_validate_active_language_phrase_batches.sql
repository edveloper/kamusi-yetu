-- 024_validate_active_language_phrase_batches.sql
-- Purpose:
-- Validate all five active-language phrase batches in one run.
--
-- Batches covered:
...
with target_batches(batch_label) as (
  values
    ('BATCH_KI_PHRASES_2026_02_25_A'::text),
    ('BATCH_LUO_PHRASES_2026_02_25_A'::text),
    ('BATCH_KAM_PHRASES_2026_02_25_A'::text),
    ('BATCH_LUY_PHRASES_2026_02_25_A'::text),
    ('BATCH_KAL_PHRASES_2026_02_25_A'::text)
),
base as (
  select
    s.id,
