-- 047_validate_luhya_subgroup_wave1_olutsotso.sql
-- Purpose:
-- Validate the first Luhya subgroup starter wave for Olutsotso.

begin;

with params as (
  select 'BATCH_LTO_STARTER_2026_02_26_A'::text as batch_label
),
base as (
  select
    s.id,
