-- 086_validate_zero_coverage_greetings_wave_1.sql
-- Purpose:
-- Validate the first zero-coverage greetings/courtesy wave.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_SOM_GREETINGS_ZERO_W1_2026_02_27_A'::text),
    ('BATCH_ORM_GREETINGS_ZERO_W1_2026_02_27_A'::text),
    ('BATCH_HIN_GREETINGS_ZERO_W1_2026_02_27_A'::text)
),
base as (
  select
    s.id,
