-- 069_apply_greetings_courtesy_wave_b.sql
-- Purpose:
-- Apply the validated second greetings/courtesy wave.

begin;

create temporary table _target_greetings_wave_b_batches (
  batch_label text primary key
) on commit drop;

insert into _target_greetings_wave_b_batches (batch_label)
values
...
with inserted as (
  ...
  select
    ...
    now()
  from _target_greetings_wave_b_batches tb
  where exists (
    select 1
...
select
  ...
  s.created_by
from public.entry_import_staging s
join _target_greetings_wave_b_batches tb on tb.batch_label = s.batch_label
...
-- where source_ref in (
--   'entry_import_staging:BATCH_PKO_GREETINGS_WAVE_B_2026_02_27_A',
--   'entry_import_staging:BATCH_SXB_GREETINGS_WAVE_B_2026_02_27_A',
--   'entry_import_staging:BATCH_LTO_GREETINGS_WAVE_B_2026_02_27_A',
--   'entry_import_staging:BATCH_BXK_GREETINGS_WAVE_B_2026_02_27_A',
--   'entry_import_staging:BATCH_RAG_GREETINGS_WAVE_B_2026_02_27_A',
--   'entry_import_staging:BATCH_TUY_GREETINGS_WAVE_B_2026_02_27_A',
--   'entry_import_staging:BATCH_ORC_GREETINGS_WAVE_B_2026_02_27_A'
-- )
