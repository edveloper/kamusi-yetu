-- 068_validate_greetings_courtesy_wave_b.sql
-- Purpose:
-- Validate the second greetings/courtesy wave.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_PKO_GREETINGS_WAVE_B_2026_02_27_A'::text),
    ('BATCH_SXB_GREETINGS_WAVE_B_2026_02_27_A'::text),
    ('BATCH_LTO_GREETINGS_WAVE_B_2026_02_27_A'::text),
    ('BATCH_BXK_GREETINGS_WAVE_B_2026_02_27_A'::text),
    ('BATCH_RAG_GREETINGS_WAVE_B_2026_02_27_A'::text),
    ('BATCH_TUY_GREETINGS_WAVE_B_2026_02_27_A'::text),
    ('BATCH_ORC_GREETINGS_WAVE_B_2026_02_27_A'::text)
),
base as (
  select
    s.id,
