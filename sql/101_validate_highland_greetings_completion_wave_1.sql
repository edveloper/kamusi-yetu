-- 101_validate_highland_greetings_completion_wave_1.sql
begin;

with target_batches(batch_label) as (
  values
    ('BATCH_EBU_GREETINGS_COMPLETION_W1_2026_02_27_A'::text),
    ('BATCH_MER_GREETINGS_COMPLETION_W1_2026_02_27_A'::text),
    ('BATCH_GUZ_GREETINGS_COMPLETION_W1_2026_02_27_A'::text),
    ('BATCH_KUR_GREETINGS_COMPLETION_W1_2026_02_27_A'::text)
),
base as (
  select
    s.id,
