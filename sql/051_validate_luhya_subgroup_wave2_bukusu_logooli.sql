-- 051_validate_luhya_subgroup_wave2_bukusu_logooli.sql
-- Purpose:
-- Validate the second Luhya subgroup starter wave for Bukusu and Logooli.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_BXK_STARTER_2026_02_26_A'::text),
    ('BATCH_RAG_STARTER_2026_02_26_A'::text)
),
base as (
  select
    s.id,
