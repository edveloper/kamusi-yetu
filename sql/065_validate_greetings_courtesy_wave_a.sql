-- 065_validate_greetings_courtesy_wave_a.sql
-- Purpose:
-- Validate the first broad greetings/courtesy wave.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_KI_GREETINGS_WAVE_A_2026_02_27_A'::text),
    ('BATCH_LUO_GREETINGS_WAVE_A_2026_02_27_A'::text),
    ('BATCH_KAM_GREETINGS_WAVE_A_2026_02_27_A'::text),
    ('BATCH_LUY_GREETINGS_WAVE_A_2026_02_27_A'::text),
    ('BATCH_KAL_GREETINGS_WAVE_A_2026_02_27_A'::text)
),
base as (
  select
    s.id,
