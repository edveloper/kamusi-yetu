-- 071_validate_greetings_courtesy_wave_c.sql
-- Purpose:
-- Validate the third greetings/courtesy wave.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_KI_GREETINGS_WAVE_C_2026_02_27_A'::text),
    ('BATCH_LUO_GREETINGS_WAVE_C_2026_02_27_A'::text),
    ('BATCH_SGC_GREETINGS_WAVE_C_2026_02_27_A'::text),
    ('BATCH_LTO_GREETINGS_WAVE_C_2026_02_27_A'::text),
    ('BATCH_BXK_GREETINGS_WAVE_C_2026_02_27_A'::text),
    ('BATCH_RAG_GREETINGS_WAVE_C_2026_02_27_A'::text),
    ('BATCH_SXB_GREETINGS_WAVE_C_2026_02_27_A'::text),
    ('BATCH_TUY_GREETINGS_WAVE_C_2026_02_27_A'::text)
),
base as (
  select
    s.id,
