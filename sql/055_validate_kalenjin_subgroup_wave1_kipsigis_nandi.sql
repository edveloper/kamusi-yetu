-- 055_validate_kalenjin_subgroup_wave1_kipsigis_nandi.sql
-- Purpose:
-- Validate the first Kalenjin subgroup starter wave for Kipsigis and Nandi.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_SGC_STARTER_2026_02_26_A'::text),
    ('BATCH_NIQ_STARTER_2026_02_26_A'::text)
),
base as (
  select
    s.id,
