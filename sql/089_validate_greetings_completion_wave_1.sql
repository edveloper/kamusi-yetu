-- 089_validate_greetings_completion_wave_1.sql
-- Purpose:
-- Validate the first greetings completion wave.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_SAQ_GREETINGS_COMPLETION_W1_2026_02_27_A'::text),
    ('BATCH_ORM_GREETINGS_COMPLETION_W1_2026_02_27_A'::text),
    ('BATCH_SOM_GREETINGS_COMPLETION_W1_2026_02_27_A'::text),
    ('BATCH_HIN_GREETINGS_COMPLETION_W1_2026_02_27_A'::text)
),
base as (
  select
    s.id,
