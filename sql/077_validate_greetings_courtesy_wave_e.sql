-- 077_validate_greetings_courtesy_wave_e.sql
-- Purpose:
-- Validate the fifth greetings/courtesy wave.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_MAS_GREETINGS_WAVE_E_2026_02_27_A'::text),
    ('BATCH_ORC_GREETINGS_WAVE_E_2026_02_27_A'::text),
    ('BATCH_SGC_GREETINGS_WAVE_E_2026_02_27_A'::text),
    ('BATCH_NIQ_GREETINGS_WAVE_E_2026_02_27_A'::text),
    ('BATCH_SPY_GREETINGS_WAVE_E_2026_02_27_A'::text),
    ('BATCH_SHENG_GREETINGS_WAVE_E_2026_02_27_A'::text)
),
base as (
  select
    s.id,
