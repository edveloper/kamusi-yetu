-- 095_validate_coastal_greetings_completion_wave_1.sql
-- Purpose:
-- Validate the first coastal greetings completion wave.

begin;

with target_batches(batch_label) as (
  values
    ('BATCH_COH_GREETINGS_COMPLETION_W1_2026_02_27_A'::text),
    ('BATCH_NYF_GREETINGS_COMPLETION_W1_2026_02_27_A'::text)
),
base as (
  select
    s.id,
