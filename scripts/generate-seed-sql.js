...
// Read the CSV file
const csvPath = path.join(__dirname, '..', 'Kamusi_Yetu_Seeds_filled.csv');
...
const outputPath = path.join(__dirname, '..', 'sql', 'seed-batch-insert-2026-05-13.sql');
fs.writeFileSync(outputPath, sqlStatements.join('\n'), 'utf-8');

console.log(`✅ Generated seed SQL: ${outputPath}`);
console.log(`📊 Total INSERT statements: ${sqlStatements.filter(s => s.startsWith('INSERT')).length}`);
